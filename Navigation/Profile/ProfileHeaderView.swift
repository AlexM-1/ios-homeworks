...
class ProfileHeaderView: UIView {
    ...
    private lazy var setStatusButton = CustomButton(title: "Set status".localizable, titleColor: .white) {
        
        [weak self] in
        self?.statusTextChanged(self?.statusTextField.text ?? "")
    ...
    private lazy var statusTextField: UITextField = {
        ...
        textField.placeholder = "Set your status...".localizable
    ...
    func statusTextChanged(_ status: String) {
        statusText = status
        if statusText == "" {
            statusText = "Status not set".localizable
        }
    }
    ...
    @objc private func handleTapGesture(_ gestureRecognizer: UITapGestureRecognizer) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0) {
            ...
            self.imageView.snp.updateConstraints { (make) in
                ...
                make.width.height.equalTo(self.bounds.width)
            }

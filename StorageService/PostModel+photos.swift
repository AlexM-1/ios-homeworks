...
public var model : [PostModel] = [
    PostModel(author: "maybe_elf. Clubhouse сократил сотрудников для оптимизации бизнеса.",
              description:
                                """
                                ...
                                """,
              image: UIImage(named: "maybe_elf") ?? UIImage(),
              likes: 41,
              views: 364),

    PostModel(author: "denis-19. Капитал Маска уменьшился на $16,9 млрд, акции Tesla упали на 9% после сообщения о планах сократить штат компании на 10%.",
              description:
                                """
                                ...
                                """,
              image: UIImage(named: "denis-19") ?? UIImage(),
              likes: 383,
              views: 1564),


    PostModel(author: "daniilshat. Apple запатентовала MacBook с поддержкой стилуса Apple Pencil.",
              description:
                                """
                                ...
                                """,
              image: UIImage(named: "daniilshat") ?? UIImage(),
              likes: 264,
              views: 584),

    PostModel(author: "hello_hella. Минцифры занялось разработкой механизма совместного использования операторами их сотовых сетей.",
                           description:
                                """
                                ...
                                """,
                           image: UIImage(named: "hello_hella") ?? UIImage(),
                           likes: 169,
                           views: 584)
                 ]

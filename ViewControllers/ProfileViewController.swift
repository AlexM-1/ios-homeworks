...
class ProfileViewController: UIViewController {
    ...
    @objc func handleDoubleTap(dpgr: UITapGestureRecognizer) {
        ...
        LikedPostsManager.default.addPost(author: modelPost.author, description: modelPost.description, imageName: modelPost.image, likes: modelPost.likes, views: modelPost.views)
...
extension ProfileViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        } else { return LikedPostsManager.default.posts.count}
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let post = LikedPostsManager.default.posts[indexPath.row]

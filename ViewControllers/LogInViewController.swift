...
class LogInViewController: UIViewController {
    ...
    private lazy var logInButton = CustomButton(title: "Log In 0 sec.", titleColor: .white) {}

    private lazy var signUpButton = CustomButton(title: "sign Up", titleColor: .white) {}
    ...
    private func setupView() {
        ...
        [logoImageView, stackView, logInButton, signUpButton].forEach { contentView.addSubview($0) }
